                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form:form action="/register" method="post" modelAttribute="newUser">
                            ...
                            <!-- ! additional fields -->
                            <div class="mb-3">
                                <form:label path="host" class="form-label">Host:  </form:label>
                                <form:select class="form-select mb-2" aria-label="Default select example" path="host">
                                    <option value="1">Host</option>
                                    <option value="0">Guest</option>
                                </form:select>
                                <form:errors  class="text-danger" path="host" />
                            </div>
