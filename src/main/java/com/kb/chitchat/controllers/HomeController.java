...
//    	httpSession.removeAttribute("userId");
    ...
    public String updatePool(@RequestParam("firstName") String firstName,
    		@RequestParam("lastName") String lastName,
    		@RequestParam("email") String email,
    		@PathVariable("id") Long id) {
    	
    	User exsitingUser =  userService.findUser(id);
    	exsitingUser.setFirstName(firstName);
    	exsitingUser.setLastName(lastName);
    	// TODO: need to check if the email is taken.
    	exsitingUser.setEmail(email);
    	// we need to set the transient still
    	exsitingUser.setConfirm(exsitingUser.getPassword());
   
    	
    	System.out.println("updating");
    	userService.saveUser(exsitingUser);
